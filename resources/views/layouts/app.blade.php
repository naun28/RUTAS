...
@section('sidebar-menu')
  <ul class="nav metismenu" id="side-menu" style="padding-left:0px;">
    ...
    <li class="active">
      <a href="{{ route('perfilesusuarios') }}"><i class="fa fa-vcard-o"></i> <span class="nav-label">Perfil de Usuarios</span></a>
    </li>
     <li class="active">
      <a href="{{ route('escuelas') }}"><i class="fa fa-list-alt"></i> <span class="nav-label">Lista de Escuelas</span></a>
    </li>
    <li class="active">
    ...
    <li class="active">
      <a href="{{ route('brigadista') }}"><i class="fa fa-male"></i> <span class="nav-label">Brigadista</span></a>
    </li>        
    <li class="active">
      <a href="{{ route('secretaria') }}"><i class="fa fa-female"></i> <span class="nav-label">Secretarias</span></a>
    </li>
    <li class="active">
